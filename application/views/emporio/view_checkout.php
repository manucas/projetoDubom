    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <!-- Form Principal -->
                <form action="<?php echo site_url('cl_emporio/checkOutGravar'); ?>"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                ...
                                maxlength="100"
                                pattern=".{3,100}"
                                title="Entre 3 e 100 caracteres."
                                value=""
                                required>
                            <div class="invalid-feedback">
                                Por favor, nome da localidade de 3 até 100 caracteres.
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                ...
                                maxlength="20"
                                pattern=".{5,20}"
                                title="Entre 5 e 20 caracteres."
                                value="">
                            <div class="invalid-feedback">
                                Por favor, Código Postal de 5 até 20 caracteres.
                            </div>
                        </div>
                    </div>
                    <!-- ./Linha com 2 colunas -->
