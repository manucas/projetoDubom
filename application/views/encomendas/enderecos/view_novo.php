...
// echo "<pre>"; print_r($dados_cli[0]['nome']); echo "</pre>";die;
?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 offset-2 order-md-1">
                ...
                <form action="<?php echo site_url('cl_encomendas/enderecosGravar/'.$cliente['id']); ?>" 
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                value="<?php echo $values ? $inputs['text_tipo'] : ''?>"
                                >
                        </div>
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                value="<?php echo $values ? $inputs['text_contato'] : ''?>"
                                >
                        </div>
                    </div>
                    <!-- ./ linha 1 -->    
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                value="<?php echo $values ? $inputs['text_cep'] : ''?>">
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                value="<?php echo $values ? $inputs['text_localidade'] : ''?>"
                                required>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                pattern=".{1,100}"
                                title="Entre 1 e 100 caracteres."
                                value="<?php echo $values ? $inputs['text_bairro'] : ''?>"
                                required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                pattern=".{1,100}"
                                title="Entre 1 e 100 caracteres."
                                value="<?php echo $values ? $inputs['text_rua'] : ''?>"
                                required>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text"
                                ...
                                value="<?php echo $values ? $inputs['text_numero'] : ''?>"
                                required>
                            <div class="invalid-feedback">
                                Por favor, número até 10 caracteres.
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                maxlength="100"
                                pattern=".{3,100}"
                                title="Entre 2 e 100 caracteres."
                                value="<?php echo $values ? $inputs['text_complemento'] : ''?>">
                        </div>
                    </div>                    
                    <!-- ./Linha 4 -->
