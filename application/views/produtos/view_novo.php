    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 offset-2 order-md-1">
                ...
                <form  action="<?php echo site_url('cl_produtos/novogravar'); ?>" 
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" 
                                        ...
                                        name="radio_grupo" 
                                        value="0"
                                        <?php if($values) if($inputs['grupo']==0) echo 'checked'; ?>
                                    >
                                    Gelo
                                </label>
                            </div>
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" 
                                        ...
                                        name="radio_grupo" 
                                        value="1"
                                        <?php if($values) if($inputs['grupo']==1) echo 'checked'; ?>
                                    >
                                    Empório
                                </label>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text" 
                                ...
                                value="<?php echo $values ? $inputs['espec'] : ''?>"
                                required
                            >
                            <div class="invalid-feedback">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="text"
                                ...
                                value="<?php echo $values ? $inputs['un_med'] : ''?>"
                                required
                                >
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="number"
                                ...
                                min="1.00"
                                max="999999999.99"
                                value="<?php echo $values ? $inputs['valor_unitario'] : ''?>"
                                required
                            >
                            <div class="invalid-feedback">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            ...
                            <input type="number"
                                ...
                                min="1.000"
                                max="99999999.999"
                                value="<?php echo $values ? $inputs['qtde_estoque'] : ''?>"
                            >
                            <div class="invalid-feedback">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 mb-2">
                            <label for="arqFoto">
                                Foto
                                <span class="text-muted">&nbsp;&nbsp;(Clique abaixo para adicionar foto)</span>
                            </label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="file" 
                                    ...
                                    <input type="hidden"
                                        name="foto_anterior"
                                        value="<?php echo $values ? $inputs['foto_anterior'] : ''?>"
                                    >
                                </div>
                            </div>
                        </div>
