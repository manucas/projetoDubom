<?php
    ...
    class Cl_Emporio extends CI_Controller{
        ...
        public function index($dados_ret = null){
            ...
            $dados_ret['produtos'] = $this->mdl_produtos->dadosEncomenda(1);

            // Apresenta View
            $this->load->view('emporio/view_inicio', $dados_ret);
        ...
        public function checkOut(){
            ...
            $this->load->view('template/topbar', $dados_ret);
            // Apresenta View
            $this->load->view('emporio/view_checkout', $dados_ret);
